...
class MainActivityViewModel(private val repo : IWeatherRepository) : ViewModel() {
    ...
    fun fetchWeatherData(lat: Double, lon: Double, unit: String, lang: String) {
        viewModelScope.launch {
            try {
//                var response : WeatherResponse?
//
//                if (unit == UnitSystem.CUSTOM.value) {
...
//                }
//                else {
//                    response = repo.fetchCurrentWeatherDataRemotely(lat, lon, unit, lang)
//                }
    ...
    fun fetchForecastData(lat: Double, lon: Double, unit: String, lang: String) {
        viewModelScope.launch {
            try {
