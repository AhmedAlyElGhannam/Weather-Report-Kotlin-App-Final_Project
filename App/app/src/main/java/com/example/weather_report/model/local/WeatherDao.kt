...
interface WeatherDao {
    ...
    //
    @Query(
        "SELECT locations.*, current_weather.weatherData, forecast_weather.forecastData " +
                "FROM locations " +
    ...
    @Query("SELECT lastUpdated FROM current_weather WHERE locationId = :locationId")
    suspend fun getWeatherLastUpdated(locationId: String): Long?
}